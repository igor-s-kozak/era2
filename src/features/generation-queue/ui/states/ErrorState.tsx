...
export function ErrorState({ onRetry }: ErrorStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-24 gap-4">
      ...
      <button
        onClick={onRetry}
        className="mt-2 h-10 px-6 rounded-full bg-[var(--era-accent)] text-white text-[14px] font-medium font-geist shadow-[0_6px_12px_rgba(232,84,33,0.4)] hover:bg-[var(--era-accent-2)] transition-colors"
      >
        Повторить
      </button>
    </div>
